...
# Define paths
zip_file_path = 'Kamaljp_cifar_500.zip'  # Path to your uploaded ZIP file
extracted_folder_path = 'Kamaljp_cifar_500_extracted'  # Path for extraction
...
# Load the dataset
dataset_path = 'Kamaljp_cifar_500_extracted'
